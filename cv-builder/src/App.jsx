...
const objectiveText =
  "Highly skilled and motivated Software Engineer with 5+ years of experience in designing and developing innovative software solutions. Seeking a challenging position in a dynamic organization where I can utilize my technical expertise and leadership skills to contribute to the success of the team";
...
export default function App() {
  ...
  const [github, setGitHub] = useState("www.example.com");
  const [linkedIn, setLinkedIn] = useState("www.example.com");
  ...
  const [projectDetails, setProjectDetails] = useState(
    "Developed a fully functional e-commerce website using Java Spring framework, MySQL database, and React frontend"
  );
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-7 gap-4 bg-white-500 min-h-screen">
      {/* Hamburger Menu - visible only on small screens */}
      <div className="flex justify-between items-center bg-customBlue p-4 md:hidden">
        <h1 className="text-2xl font-bold text-white">Sulav's CV BUILDER</h1>
        <button
      ...
      {/* Sidebar */}
      <div
        className={`md:col-span-2 p-2 bg-customBlue rounded-md shadow-md h-screen overflow-y-auto ${
          isSidebarOpen ? "block" : "hidden"
        } md:block`}
      >
        <h1 className="text-2xl md:text-3xl text-center font-bold shadow-md p-4 text-white">
          CV BUILDER
        </h1>
        <br />
        ...
        <div className="p-4 bg-slate-200 rounded-md shadow-md">
          ...
          <GithubFunc
            github={github}
            updateGithub={(e) => setGitHub(e.target.value)}
          />

          <p className="font-bold">LinkedIn</p>
          <LinkedInFunc
            linkedIn={linkedIn}
            updateLinkedIn={(e) => setLinkedIn(e.target.value)}
          />

          <p className="font-bold">Profile Summary</p>
          <ObjectiveFunc
            objective={objective}
        ...
        <div className="p-4 bg-slate-200 rounded-md mt-2 shadow-md">
          ...
          <div className="text-center">
            <button
              ...
              className="rounded-lg w-full bg-customBlue text-white hover:bg-sky-700 p-2 mt-2"
            >
              Add Skill
            </button>
          </div>
      ...
      <div
        ref={cvRef}
        className="md:col-span-5 bg-white shadow-md overflow-auto md:h-screen"
      >
        ...
        <div className="p-4 mb-4">
          ...
          <p>{school}</p>
          <p>
            {degree} from {startDate} to {endDate}
          </p>
          <br />
          <p className="font-bold text-lg">Work Experience</p>
          <p>
            {position} at {companyName}, from {experienceStartDate} to{" "}
            {experienceEndDate}
          </p>
        ...
        <div className="text-center my-4">
          <button
            ...
            className={`rounded-lg bg-sky-500 hover:bg-sky-700 p-2 ${
